...
std::vector<int> GuessLMSSort(const std::vector<int> &text,
                              std::vector<int> &bucket_sizes,
                              const std::vector<char> &type_map);
void InduceSortL(const std::vector<int> &text,
                 const std::vector<int> &bucket_sizes,
                 const std::vector<char> &typemap,
                 std::vector<int> *guessed_suffix_array);
void InduceSortS(const std::vector<int> &text,
                 const std::vector<int> &guessed_suffix_array,
                 const std::vector<char> &typemap,
                 std::vector<int> *bucket_sizes);
...
std::vector<int> AccurateLMSSort(
    const std::vector<int> &text, const std::vector<int> &bucket_sizes,
    const std::vector<char> &typemap,
